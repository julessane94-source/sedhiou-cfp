    ...
    <div className="pt-24 pb-20 px-4 bg-[#f7f2ef] min-h-screen">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="mt-4 text-stone-600 max-w-2xl mx-auto">{contact?.subtitle || 'Nous sommes là pour répondre à vos questions et vous accompagner dans votre projet de formation.'}</p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5 bg-white rounded-[2rem] p-8 shadow-xl border border-white/80">
            <div className="space-y-8">
              <div>
                <h2 className="text-2xl font-bold text-stone-900 mb-3">Coordonnées</h2>
                <div className="space-y-4 text-stone-700">
                  <div className="flex items-start gap-4">
                    <span className="mt-1 text-[#772a1d]">📍</span>
                    <p>{contact?.address || 'Adresse non renseignée'}</p>
                  </div>
                  <div className="flex items-start gap-4">
                    <span className="mt-1 text-[#772a1d]">📞</span>
                  ...
                  <div className="flex items-start gap-4">
                    <span className="mt-1 text-[#772a1d]">✉️</span>
                    <p>{contact?.email || 'Email non renseigné'}</p>
                  </div>
                  <div className="flex items-start gap-4">
                    <span className="mt-1 text-[#772a1d]">🕒</span>
                    <p>{contact?.hours || 'Heures non renseignées'}</p>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-7 bg-[#772a1d] rounded-[2rem] p-8 shadow-xl text-white relative overflow-hidden">
            ...
            <div className="relative space-y-6">
              ...
              <p className="max-w-xl text-stone-100">Remplissez ce formulaire et notre équipe vous répondra rapidement.</p>
