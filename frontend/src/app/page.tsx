    ...
    <div className="animate-fade-in">
      <section className="relative h-screen flex items-center justify-center bg-gradient-to-br from-bordeaux-900 to-bordeaux-800 text-white">
        <div className="relative z-10 text-center px-4">
          ...
          <Link href="/formations" className="inline-block bg-white text-bordeaux-800 px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition transform hover:-translate-y-1">Nos formations</Link>
        </div>
      </section>
