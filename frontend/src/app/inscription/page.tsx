      ...
      <div className="container mx-auto max-w-5xl">
        <div className="text-center mb-8">
          ...
          <p className="text-stone-600 animate-fade-in animation-delay-200">
            Remplissez le formulaire ci-dessous pour postuler ÃƒÂ  nos formations.
          </p>
        </div>
        ...
        <div className="text-center mt-6 text-stone-500 text-sm">
          Les informations collectÃƒÂ©es sont utilisÃƒÂ©es uniquement pour le traitement de votre candidature.
        </div>
      </div>
    </div>
  )
